...
class ClassWorlds extends DefaultTask {
        ...
        private def generateLauncherScripts(File binDir, String bootJarFileName, String appHome) {
                ...
                def shellComments = "Generated by the Gradle ClassWorlds Plugin"
                def shellCommentsPrefixes = ["#", "REM"]
                ...
                launcherFileNames.eachWithIndex { launcherName, listIndex ->
                        ...
                        def scriptComments = shellCommentsPrefixes[listIndex] + shellComments
                        def tplModel = [appHome:appHome, bootJarFileName:bootJarFileName, shellHeader:shellHeader, shellComments:scriptComments]
